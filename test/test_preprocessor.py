...
@pytest.fixture
def data_frame_x():
    data_column = data_frame_xy().iloc[:, 0]
    return pd.DataFrame(data_column)


@pytest.fixture
def opener_mock():
    fake_file = 'data, time_to_failure\n27, 0.1\n-3, 0\n15, 0.1\n-13, 0\n14, 1'

    opener_mock = mock.mock_open(read_data=fake_file)
